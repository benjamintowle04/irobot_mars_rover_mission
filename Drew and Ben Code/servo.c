...
/**
 *
 * Find MATCHR value for 0 and 180 degrees then setup code so that when getting to points the coimputer checks that the matchr valkues are correct based of the MATCHR
 *
 *
 */
